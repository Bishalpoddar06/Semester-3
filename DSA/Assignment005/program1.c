/*
write a program in C to perform the following stack operations with a menu based system.
 Observe the fow of data in stack and write the outputs in your laboratory notes.
